...
namespace News_2.Extensions
{
    public static class DbContextExtensions
    {
        public static void UpdateManyToMany<T, KEY>(this NewsDbContext db, IEnumerable<T> currentItems, IEnumerable<T> newItem, Func<T, KEY> getKey) where T: class
        {
